...
function validateRoomInputs(){
  ...
  else if(arrDate.value > depDate.value){
    alert("Check out date should be a later date than the check in date")
  }
...
function clearOverallBookingDetails(){
  rsOvrCountElement.innerHTML = '';
  rdOvrCountElement.innerHTML = '';
  rtOvrCountElement.innerHTML = '';
  roomOvrCountElement.innerHTML = '';
  totalOvrPriceElement.innerHTML = '';
